...
// The RewriteTag Filter plugin allows you to operate on or with nested data. Its modes of operation are
...
func (n *RewriteTag) Params(_ plugins.SecretLoader) (*plugins.KVs, error) {
	...
	if n.EmitterName != "" {
		kvs.Insert("Emitter_Name", n.Operation)
	}
	if n.EmitterStorageType != "" {
		kvs.Insert("Emitter_Storage.type", n.RemovePrefix)
	}
	return kvs, nil
}
